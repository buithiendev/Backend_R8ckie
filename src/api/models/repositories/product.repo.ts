...
import { BadRequestError } from '../../v1/core/error.response'
import {
    OptionProduct,
    UpdateProductPayload,
} from '../../v1/interfaces/product/ProductService.interface'
import {
    getSelectData,
    getUnSelectData,
    removeSpacingString,
...
const findProductByIdAndVariantId = async (
    productId: string,
    variantId: string,
    select: string[],
) => {
...
const findProductById = async (
    ...
    const result = await productModel
        ...
        .populate(
            'product_variants',
            'price inventory_quantity sku option1 option2 option3 _id',
        )
