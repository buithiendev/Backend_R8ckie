...
exports.updateTagsById = exports.updateProductById = exports.unPublishProductByAdmin = exports.removeSpacingString = exports.refactorListOption = exports.publishProductByAdmin = exports.findProductByIdNotLean = exports.findProductByIdAndVariantId = exports.findProductById = exports.findAllVariantsByProductId = exports.findAllProduct = exports.createProduct = exports.countProduct = exports.checkOptionAndVariantValue = void 0;
const mongoose_1 = require("mongoose");
const error_response_1 = require("../../v1/core/error.response");
...
const findProductByIdAndVariantId = async (productId, variantId, select) => {
    const filter = {
        _id: productId,
        product_variants: {
            $in: [variantId],
    ...
    return await product_model_1.default
        .findOne(filter)
        .populate({ path: 'product_variants', match: { _id: variantId } })
        .select((0, utils_1.getSelectData)(select))
        .lean()
        .exec();
};
exports.findProductByIdAndVariantId = findProductByIdAndVariantId;
const findAllProduct = async (limit, page, sort, filter, select) => {
    ...
    const results = await product_model_1.default
        ...
        options: { limit: 1 },
        select: 'price inventory_quantity sku option1 option2 option3 _id',
    })
        .sort(sortBy)
        .skip(skip)
        .limit(limit)
...
const findProductById = async (productId, filter, unSelect) => {
    const result = await product_model_1.default
        ...
        .populate('product_variants', 'price inventory_quantity sku option1 option2 option3 _id')
